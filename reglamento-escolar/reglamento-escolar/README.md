...
You can then execute your native executable with: `./target/reglamento-escolar-1.0.0-SNAPSHOT-runner`
...
- LangChain4j OpenId Connect (OIDC) Client ModelAuthProvider ([guide](https://docs.quarkiverse.io/quarkus-langchain4j/dev/index.html)): Provides McpClientAuthProvider which uses OIDC client to acquire access tokens
- LangChain4j OpenId Connect (OIDC) ModelAuthProvider ([guide](https://docs.quarkiverse.io/quarkus-langchain4j/dev/index.html)): Provides McpClientAuthProvider which uses OIDC bearer or authorization code flow access tokens
